...
export const EventInfoForm: FC<EventInfoFormProps> = ({ setIsActiveInfo }) => {
  ...
  const [valuePushkin, setValuePushkin] = useState<string>();
  const [valueAge, setValueAge] = useState<string>();
  const [valueEntrance, setValueEntrance] = useState<string>();
  ...
  const handleButtonClick = () => {
    ...
    if (valuePushkin) {
      setFormData({
        ...formData,
        payment: selectPushkinItem.indexOf(valuePushkin).toString(),
      });
    }
